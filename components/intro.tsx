    ...
    return (
        <section ref={ref} className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]" id="home">
            ...
            <p className="mb-10 mt-2 sm:mx-auto sm:w-[40rem] px-4">
                I am a Sofware Engineer specializing in building backend and ML services with over <a href="#experience" className="hyperlinks">2 years</a> of experience. I'm currently working with <a href="https://www.84lumber.com/" className="hyperlinks">84 Lumber</a> as an AI Solutions Architect.
            </p>
